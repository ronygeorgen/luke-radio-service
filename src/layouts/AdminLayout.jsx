...
import { Settings, Layers, Users, Plus, UserCog, ChevronDown, Music, BarChart3, FileText, Search, LifeBuoy, Clock, Filter } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-full">
                ...
                <div className="relative">
                    ...
                    <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${isDropdownOpen === 'settings' ? 'rotate-180' : ''}`} />
                    </button>
                    ...
                    <div className="absolute right-0 mt-2 w-[28rem] bg-white rounded-xl shadow-2xl border border-gray-200 py-3 z-50 backdrop-blur-sm">
                        ...
                        <div>
                            ...
                            <button onClick={() => { navigate("/user-channels"); setIsDropdownOpen(null); }} className="flex items-center w-full px-3 py-2 text-sm font-medium text-gray-800 hover:bg-blue-50 rounded-lg transition-colors duration-200">
