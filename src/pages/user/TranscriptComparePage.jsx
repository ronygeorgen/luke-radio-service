        ...
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
              {[
                { step: 1, title: 'Select Segments' },
                { step: 2, title: 'Choose Prompt' },
                { step: 3, title: 'Run Compare' }
              ].map((item) => (
                <button
                  key={item.step}
                  type="button"
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {canContinueToPrompt && (
                <button
                  ...
                  className="ml-auto inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 transition-colors"
                >
                  Continue to Prompt
