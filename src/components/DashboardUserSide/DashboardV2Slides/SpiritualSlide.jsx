...
const SpiritualSlide = () => {
  ...
  const dummyData = {
    byContentNumber: [
      { name: 'CHRISTIAN PRACTICES', value: 12 },
      { name: 'CHRISTIAN COMMUNITY', value: 26 },
      { name: 'FAITH JOURNEY', value: 28 },
    ],
    byContentTime: [
      { name: 'CHRISTIAN PRACTICES', value: 23, color: '#ffffff' },
      { name: 'CHRISTIAN COMMUNITY', value: 18, color: '#3b82f6' },
      { name: 'FAITH JOURNEY', value: 14, color: '#000000' },
    ],
    totalTime: [
      { category: 'Product', value: 205 },
      { category: 'Marketing', value: 165 },
      { category: 'Sales', value: 150 },
      { category: 'Operations', value: 145 },
      { category: 'IT & Support', value: 85 },
    ],
    metrics: {
      totalOvertime: 750,
