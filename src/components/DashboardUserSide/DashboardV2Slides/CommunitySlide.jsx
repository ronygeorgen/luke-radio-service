...
const CommunitySlide = () => {
  ...
  const dummyData = {
    byContentNumber: [
      { name: 'ATMOSPHERE', value: 12 },
      { name: 'RELATIONSHIPS', value: 26 },
      { name: 'GENEROSITY', value: 28 },
      { name: 'FUN', value: 16 },
    ],
    byContentTime: [
      { name: 'ATMOSPHERE', value: 23, color: '#000000' },
      { name: 'RELATIONSHIPS', value: 18, color: '#1e3a8a' },
      { name: 'GENEROSITY', value: 14, color: '#ef4444' },
      { name: 'FUN', value: 19, color: '#14b8a6' },
    ],
    totalTime: [
  ...
  return (
    <div className={`min-h-screen p-8 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">COMMUNITY</h2>
            ...
            <div className="space-y-4">
              {dummyData.byContentNumber.map((item, index) => (
                ...
                >
                  ...
                  <div className="w-full bg-white rounded-full h-3 border border-orange-300 overflow-hidden">
                    <div
                      className="bg-orange-500 h-3 rounded-full origin-left"
                      style={{
