              ...
              <label className="flex items-center space-x-2 bg-white border border-gray-300 rounded-lg px-3 py-1.5 cursor-pointer hover:bg-gray-50 transition-colors">
                <div className="relative inline-flex items-center">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`w-10 h-5 rounded-full transition-colors ${showAllTopics ? 'bg-blue-500' : 'bg-gray-300'
                    }`} />
                  <div className={`absolute left-0.5 top-0.5 bg-white w-4 h-4 rounded-full transition-transform ${showAllTopics ? 'transform translate-x-5' : ''
                    }`} />
                </div>
